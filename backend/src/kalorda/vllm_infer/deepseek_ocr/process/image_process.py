...
from ..config import BASE_SIZE, CROP_MODE, IMAGE_SIZE, MAX_CROPS, MIN_CROPS, PROMPT  # , TOKENIZER # edit by zhaoying
...
class DeepseekOCRProcessor(ProcessorMixin):
    ...
    def __init__(
        self,
        # tokenizer: LlamaTokenizerFast = TOKENIZER, # edit by zhaoying # move to vllm_offline_infer.py
